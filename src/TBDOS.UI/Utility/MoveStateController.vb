...
Friend Class MoveStateController
    ...
    Public Function HandleKeyDown(key As Keys) As UIStates Implements IUIStateController.HandleKeyDown
        Select Case key
            ...
            Case Keys.A
                _world.PlayerCharacter.Navigation.MoveAhead()
                Return UIStates.InPlay
            Case Keys.B
                _world.PlayerCharacter.Navigation.MoveBack()
                Return UIStates.InPlay
            Case Keys.L
                _world.PlayerCharacter.Navigation.MoveLeft()
                Return UIStates.InPlay
            Case Keys.R
                _world.PlayerCharacter.Navigation.MoveRight()
                Return UIStates.InPlay
        End Select
