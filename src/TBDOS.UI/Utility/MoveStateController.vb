...
Friend Class MoveStateController
    ...
    Public Function HandleKeyDown(key As Keys) As UIStates Implements IUIStateController.HandleKeyDown
        Select Case key
            ...
            Case Keys.A
                _world.PlayerCharacter.Navigation.Move.Ahead()
                Return UIStates.InPlay
            Case Keys.B
                _world.PlayerCharacter.Navigation.Move.Back()
                Return UIStates.InPlay
            Case Keys.L
                _world.PlayerCharacter.Navigation.Move.Left()
                Return UIStates.InPlay
            Case Keys.R
                _world.PlayerCharacter.Navigation.Move.Right()
                Return UIStates.InPlay
        End Select
